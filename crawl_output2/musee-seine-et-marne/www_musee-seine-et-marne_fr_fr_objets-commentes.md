# https://www.musee-seine-et-marne.fr/fr/objets-commentes/
...
Rechercher:
Rechercher sur tout le site
!Gouge de sabotier comportant une virole en or
 1. Accueil
 2. Musée
 3. Objets commentés 
...
Un musée de société 
# Objets commentés
Vous trouverez dans cette rubrique une sélection d’objets commentés issus des collections du musée ou des expositions temporaires. 
 * Notre liste d'objets 

### Notre liste d'objets 
#### Agriculture et élevage 
 * Charrue de Brie du 19ème siècle
 * Fourche-arrache betterave
 * La culture de la pomme : Alambic Deroy 
...
#### Industrie 
 * Meule monolithique
 * Fabrication du fromage de Brie - La Caillette
 * Fabrication du fromage de Brie - Table d'égouttage

#### Vêtement 
 * Coiffe briarde, la "marmotte"

#### Faits de société 
 * Caddie de supermarché
 * Carte postale : Thomery-Plage

#### Travail 
 * Montage photographique sur le métier d'Hôtesse d'accueil, par Catherine Poncin
 * Montage photographique sur le métier de Fauchage de bords de routes, par Catherine Poncin
