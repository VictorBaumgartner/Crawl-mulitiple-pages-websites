# https://www.musee-seine-et-marne.fr/fr/manifestations-programmation/
...
Rechercher sur tout le site
 ...
 2. Infos pratiques
 3. FAQ
 4. Manifestations / Programmation 
...
Sommaire 
 * Questions / réponses 
 * Comment connaître la programmation du musée ? 
 * Quelle est l’exposition temporaire en ce moment ? 
 * Comment se renseigner sur des manifestations passées ? 
 * Comment recevoir des informations sur la programmation culturelle ? 
 * Le musée propose-t-il des activités pour le jeune public ? 

## Questions / réponses 
### Comment connaître la programmation du musée ? 
Plusieurs moyens sont à votre disposition :
 * Vous connecter régulièrement sur notre site et lire nos Actualités ou consulter notre Agenda.
 * Vous inscrire à la newsletter du musée.
 * Vous connecter au portail 

### Quelle est l’exposition temporaire en ce moment ? 
 * Pour connaître les actualités du musée, consultez la rubrique Actualités.

### Comment se renseigner sur des manifestations passées ? 
 * Vous pouvez obtenir des renseignements sur des manifestations passées en consultant notre Espace presse ou en nous adressant directement votre demande par le 

### Comment recevoir des informations sur la programmation culturelle ? 
 * En vous abonnant gratuitement à la newsletter du musée.

### Le musée propose-t-il des activités pour le jeune public ? 
 * Pour obtenir des renseignements sur les activités jeune public en groupes, contacter le musée au 01 60 24 46 00 ou à l’aide du formulaire de contact.
 * Pour les activités jeune public individuel, consulter la rubrique actualités et l’agenda. Vous pouvez également vous abonner gratuitement la newsletter.

## Contact 
Si vous souhaitez obtenir plus d'informations, posez votre question via le formulaire de contact. 
