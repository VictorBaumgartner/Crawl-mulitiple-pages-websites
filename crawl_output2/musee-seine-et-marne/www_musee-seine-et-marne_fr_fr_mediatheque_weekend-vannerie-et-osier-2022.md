# https://www.musee-seine-et-marne.fr/fr/mediatheque/weekend-vannerie-et-osier-2022/
...
Rechercher sur tout le site
 ...
 4. Weekend Vannerie et Osier 2022 
...
Musée 
# Weekend Vannerie et Osier 2022
Samedi 24 et dimanche 25 septembre 2022, le musée de la Seine-et-Marne accueillait les vanniers de l'association "Nature et Patrimoine" pour un weekend de découverte et d'initiation à la vannerie. 
Publié le 5 octobre 2022 
!Agrandir l’image Plusieurs fagots de brins d'osier secs disposés devant l'oseraie du musée !Agrandir l’image Au premier plan, les plantes qui poussent devant le musée. On observe en arrière plan, plusieurs personnes observant les vanniers exposant leur travail. !Agrandir l’image Une vannière renseigne des visiteurs devant plusieurs fagots d'osier. !Agrandir l’image Plusieurs fagots d'osier sont exposés dans la cour du musée. !Agrandir l’image Plusieurs paniers en osier exposés sur une table dans la cour du musée !Agrandir l’image Plusieurs paniers en osier dans la cour du musée. Certains sont posés au sol, d'autres suspendus à un arbre. !Agrandir l’image Plusieurs paniers en osier dans le cour du musée. Certains sont posés au sol, d'autres suspendus à un arbre. !Agrandir l’image Une vannière tresse un petit panier dans la cour du musée. !Agrandir l’image Des visiteurs observent des vanniers et s'initient à la vannerie dans la cour du musée. !Agrandir l’image Quatre nichoirs en osier sont suspendus à un pommier dans la cour du musée. !Agrandir l’image Plusieurs paniers, de taille et de forme différentes sont suspendus à une structure métallique. !Agrandir l’image Plusieurs paniers sont exposés sur une table devant un tambour de tannerie en bois dans la cour du musée. !Agrandir l’image Les vanniers de l'association "Nature et Patrimoine", posant, paniers en mains, dans la cour du musée. !Agrandir l’image Plusieurs paniers exposés à l'intérieur du musée. En arrière plan, un vannier tresse un panier. !Agrandir l’image Plusieurs paniers exposés dans le musée. Des vanniers renseignent les visiteurs. !Agrandir l’image Un panneau indique une exposition sur "L'osier : la plante nature" avec plusieurs objets anciens en vannerie. !Agrandir l’image Un berceau, une cage à oiseau et deux paniers en osier, exposés dans le musée. !Agrandir l’image Un ancien berceau à roulettes en osier exposé dans le musée. !Agrandir l’image Une cage à oiseau ancienne en osier, disposée sur un socle, est exposée à l'intérieur du musée. !Agrandir l’image Un panier en osier, disposé sur un socle, est exposé dans le musée.
Retour en images sur cet événement. Au programme : démonstrations, ateliers d'initiations, vente d'osier et de vannerie, film et conférence pour un weekend riche en activités. Une bonne occasion de découvrir cette plante utile qui fut largement cultivée dans la vallée du Petit Morin. Prochain rendez-vous en 2023...
 * Precedent
 * Retour à la liste
 * Suivant
