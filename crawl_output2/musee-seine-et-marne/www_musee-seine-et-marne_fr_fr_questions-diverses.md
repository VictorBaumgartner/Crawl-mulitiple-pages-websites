# https://www.musee-seine-et-marne.fr/fr/questions-diverses/
...
Rechercher:
Rechercher sur tout le site
!Visuel composé de lettres imbriquées
 1. Accueil
 2. Infos pratiques
 3. FAQ
...
Sommaire 
 * Questions / réponses 
 * Mécénat et partenariat avec le musée, comment cela se passe-t-il ? 
 * Qui s’occupe du site Internet du musée ? 
 * Comment contacter le musée ou un membre du personnel via Internet ? 
 * Peut-on lire dans le musée ? 

## Questions / réponses 
### Mécénat et partenariat avec le musée, comment cela se passe-t-il ? 
 * Pour des partenariats scientifiques et/ou culturels, merci de contacter le musée par le . 
 * Pour soutenir financièrement ou en compétences le musée, prendre contact avec 

### Qui s’occupe du site Internet du musée ? 
Pour toute remarque concernant le site Internet du musée, merci de nous contacter via le .
### Comment contacter le musée ou un membre du personnel via Internet ? 
La solution la plus simple est de nous contacter via le ou par la rubrique Equipe.
### Peut-on lire dans le musée ? 
 * Une bibliothèque accessible sur réservation vous propose des ouvrages de et sur Pierre Mac Orlan et des ouvrages en sciences humaines. 
 * Des livres pour les enfants sont en accès libres dans le musée.
