# https://www.musee-seine-et-marne.fr/fr/restauration-librairie/
...
## Questions / réponses 
### Où puis-je me restaurer à proximité du musée ? 
 * Il existe plusieurs possibilités pour se restaurer près du musée :

La boulangerie de la Vallée (Place de l'église, Saint-Cyr-sur-Morin)
Le Saint-Cyr (bar) qui propose de la nourriture asiatique (Place de l'église, Saint-Cyr-sur-Morin)
La Cantine de l'Oeuf dur, un restaurant installé dans l'ancienne auberge de l'Oeuf dur qui propose un plat du jour (avec option végétarienne) avec des produits de saison (Promenade Pierre Mac Orlan, Saint-Cyr-sur-Morin)
 * Pour connaître des adresses de restauration mais aussi d’hébergement ; rendez vous sur le site internet de ou dans la rubrique Autour du musée.

### Est-il possible d'acheter en ligne des catalogues, des affiches ou des cartes postales ? 
 * La vente en ligne n'est pas encore possible. 
 * Pour les ouvrages, la vente par correspondance est possible, pour cela, rendez vous dans la rubrique Boutique.

### Comment contacter la librairie / boutique ? 
Rendez vous dans la rubrique Boutique ou remplissez le .
## Contact 
#### Pour plus d'infos
