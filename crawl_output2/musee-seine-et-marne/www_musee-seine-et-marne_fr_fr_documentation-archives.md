# https://www.musee-seine-et-marne.fr/fr/documentation-archives/
...
Musée Pratique 
# Documentation / Archives
!Agrandir l’image La salle de consultation des images fixes © Evelyne Baron - MDSM
Toutes les réponses aux questions les plus fréquemment posées. 
Sommaire 
 * Questions / réponses 
 * Peut-on effectuer des recherches au musée ? 
 * Comment obtenir des informations sur une œuvre conservée par le musée ? 
 * Où se procurer des ressources pour les enseignants et les éducateurs ? 
 * Comment obtenir des informations sur l’histoire du musée ? 
 * Comment obtenir des informations sur Pierre Mac Orlan ? 

## Questions / réponses 
### Peut-on effectuer des recherches au musée ? 
 * Les chercheurs sont toujours les bienvenus au musée. Pour en savoir plus consultez la rubrique Chercheurs.

### Comment obtenir des informations sur une œuvre conservée par le musée ? 
 * Vous pouvez obtenir ces informations en consultant notre rubrique Musée de société ou en nous contactant par le formulaire de contact.

### Où se procurer des ressources pour les enseignants et les éducateurs ? 
 * Des documents de préparation et d’aide à la visite sont téléchargeables dans les rubriques scolaires et centres de loisirs.
 * Vous pouvez aussi nous contacter à l’aide du formulaire de contact. 

### Comment obtenir des informations sur l’histoire du musée ? 
 * Vous pouvez obtenir ces informations en consultant la rubrique Musée ou en nous contactant à l’aide du formulaire de contact 

### Comment obtenir des informations sur Pierre Mac Orlan ? 
 * Vous pouvez obtenir ces informations en consultant la rubrique Pierre Mac Orlan ou en nous contactant à l’aide du formulaire de contact

## Contact 
Pour plus d'informations, utilisez le formulaire de contact.
