# https://www.musee-seine-et-marne.fr/fr/edition-ouvrages/
...
Musée Pratique 
# Edition / Ouvrages
!Agrandir l’image Couvertures des Cahiers Pierre Mac Orlan 
Toutes les réponses aux questions les plus fréquemment posées. 
## Questions / réponses 
### Comment obtenir des informations sur les ouvrages publiés et/ou en vente au musée ? 
Vous pouvez consulter la rubrique Boutique, sinon n’hésitez pas à nous contacter
au 01 60 24 46 00.
### Peut-on commander en ligne ? 
La vente en ligne n'est pas encore possible. Vous pouvez toutefois commander des ouvrages par correspondance ; pour cela, rendez vous dans la rubrique Boutique.
### Peut-on consulter des livres ou catalogues d’exposition ? 
 * Des livres sont à votre disposition au centre de documentation sur réservation. Voir la rubrique Centre de ressources.

## Contact 
Pour plus d'informations, rendez-vous dans la rubrique Boutique ou utilisez le formulaire de contact.
