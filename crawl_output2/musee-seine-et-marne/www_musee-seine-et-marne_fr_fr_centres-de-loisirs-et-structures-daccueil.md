# https://www.musee-seine-et-marne.fr/fr/centres-de-loisirs-et-structures-daccueil
...
Publics 
# Centres de loisirs et structures d'accueil
Tout savoir sur les centres de loisirs et sur les structures d'accueil des familles. 
## Home support for seniors
!Benoît Bourdon en animation dans une classe de l'école élémentaire de Saint-Cyr-sur-Morin
### Animations hors les murs 
Le Musée de la Seine-et-Marne sort de ses murs ! Du mois de septembre jusqu'à la fin du mois de mars, vous avez la possibilité de faire venir un médiateur pour des animations dans votre établissement. Découvrez ci-dessous l'offre d'animations disponi... 
!matériel pédagogique pour l'atelier fromage de Brie
### Parcours en autonomie avec activités 
Ci-dessous les thèmes d’animations proposés en autonomie, avec mise à dispo... 
!photo de rayons de miel dans une ruche
### Contes et des rencontres 
Les animations proposées ci-dessous sont effectuées au musée par des interv... 
...
### Visites complémentaires 
Le musée départemental de la Seine-et-Marne propose pour tous les niveaux d... 
!Le musée vu de l'avenue de La Ferté-sous-Jouarre par temps ensoleillé
### Modalités de visite centres de loisirs et structures d'accueil des familles 
Les modalités de visite sont les mêmes que pour les groupes scolaires : 
