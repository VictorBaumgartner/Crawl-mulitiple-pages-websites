# https://www.musee-seine-et-marne.fr/fr/modalites-de-visite-visiteurs-handicapes
...
Rechercher:
Rechercher sur tout le site
!Dispositif d'aide à la visite à destination des personnes mal ou non voyantes. Page d'un livre illustré, transcrite en braille 
 1. Accueil
 2. Publics
 3. Secteur social et handicap
 4. Modalités de visite 
...
Publics 
# Modalités de visite
Dans cette rubrique, vous trouverez tous les renseignements nécessaires à la préparation de votre visite au musée départemental de la Seine-et-Marne. 
Sommaire 
 * Conditions d'animation et de visite 
...
## Conditions d'animation et de visite 
### Quelques règles à respecter 
 * L'accueil des groupes s'effectue aux horaires d’ouverture du musée.
 * Un seul groupe à la fois par animation (le nombre de participants est à déterminer avec les médiateurs du musée).
 * Selon le handicap, la présence d’accompagnateurs est indispensable ou fortement conseillée.
 * Certaines règles sont à rappeler aux visiteurs avant leur venue, afin de protéger les collections : ne pas toucher aux objets (sauf si le médiateur les y engage), ne pas boire, ne pas manger, ne pas mâcher de chewing-gum, ne rien jeter par terre, ne pas courir, crier ou se bousculer, ne pas utiliser d’autre matériel que celui recommandé par le médiateur, éteindre les téléphones portables, les photographies sont interdites à la maison de Mac Orlan.

## Renseignements et réservations 
### Comment nous contacter ? 
Les visites en groupe, libres ou guidées, les animations et les ateliers se font exclusivement sur réservation. Les demandes de renseignements s’effectuent par téléphone, par courrier, par courriel, par télécopie ou sur place. La prise de réservation s’effectue uniquement par téléphone. Une confirmation de visite est envoyée à l’organisateur sur demande.
 * Contact : 01 60 24 46 00.

En cas d’annulation, veillez à prévenir le service des publics le plus tôt possible.
## Tarifs & modalités 
### Tarifs 
 * Pour consulter les tarifs rendez-vous dans notre rubrique "Horaires et tarifs".

### Restauration 
Il n’est pas possible de se restaurer dans les espaces du musée.
Une aire de pique-nique est accessible près de la mairie, au bord du Petit Morin.
## Contact 
